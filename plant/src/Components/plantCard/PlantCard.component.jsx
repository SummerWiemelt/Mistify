  ...
  render() {
    if (this.props) {
      const plants = this.props.plants.map(plant => {
        return (
          <Col className='card-col' /* test xl={3} */ lg={4} md={6}>
            <Card className='card'>
            <div className='button-parent'>
              ...
              <Card.Body>
                <Card.Title><span className='bold'>{plant.name}</span></Card.Title>
                <Card.Text>
                ...
                <Card.Text><span className='bold'>Description: </span>{plant.description}</Card.Text>
              </Card.Body>
              <Card.Footer>
              ...
              <Link to='/viewPlant'>
                <Button className='view-plant-button' variant="outline-dark">View Plant</Button>
              </Link>
            </Card>
          </Col>
        );
